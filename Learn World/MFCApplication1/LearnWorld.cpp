...
int PreDlg_Of_ForgotPass = 0;
int PreDlg_Of_EditInfo = 0;
int isServerOnline = 0;
int ViewRateMode = 1;
int PreviousSkill = 0;
int PreDlg_Of_Evalute = 0;
int CheckSkill = 0;
Account CurAccount;
// CMFCApplication1App
...
BOOL CMFCApplication1App::InitInstance()
{
	...
	case -1:
		...
		break;
		//delete SignInDlg::CurSIGNIN;
		//delete SignUpDlg::CurSIGNUP;
		//delete RuleDlg::CurRULE;
		//dlg.DestroyWindow();
	}
